...
import com.example.nivala.adapter.TopStatusAdapter;
import com.example.nivala.adapter.UsersAdapter;
import com.example.nivala.databinding.FragmentChatBinding;
import com.example.nivala.databinding.FragmentGiveBinding;
import com.example.nivala.model.Status;
import com.example.nivala.model.User;
import com.example.nivala.model.UserStatus;
...
//        switch (item.getItemId()) {
//            case R.id.group:
//                startActivity(new Intent(ChatFragment.this, GroupChatActivity.class));
//                break;
//            case R.id.search:
